...
export const sourceRecords = [
  {
    ...
    artifactId: ARTIFACT_IDS.bellabeat,
  ...
  },
  {
    ...
    artifactId: ARTIFACT_IDS.resume,
    sourceType: "local-file",
    originalPath: "content/reservoir/artifacts.ts",
  ...
  },
  {
    ...
    artifactId: ARTIFACT_IDS.reservoirStudy,
    sourceType: "local-file",
  ...
  },
  {
    ...
    artifactId: ARTIFACT_IDS.brandSymbol,
    sourceType: "manual",
