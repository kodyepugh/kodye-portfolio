...
export const RESUME_DOCUMENT_BLOCKS = [
  {
    ...
    type: "paragraph",
    text: "Systems-oriented analyst experienced in workflow improvement, requirements translation, and cross-functional operations across federal service, digital systems, and production environments. Applies business analysis, implementation support, program operations, and data analysis to identify process gaps and support informed decisions.",
  },
  { id: "education-certifications", type: "heading", level: 2, text: "Education & Certifications" },
  {
    id: "loyola-marymount-university",
    type: "entry",
    title: "Loyola Marymount University",
    meta: "2024",
    subtitle: "Los Angeles, CA | Master of Fine Arts, Film and Television Production (Directing Fiction)",
  },
  {
    ...
    meta: "2020",
    subtitle: "Palo Alto, CA | Bachelor of Arts, Film and Media Studies (Film, Media and Technology)",
    supporting: "Relevant coursework: Programming Methodology, Programming Abstractions, Calculus I-III, Introductory Electronics I-II, Digital/Physical Design",
  },
  {
    id: "blair-academy",
    type: "entry",
    title: "Blair Academy",
    meta: "2016",
    subtitle: "Blairstown, NJ | High School Diploma",
  },
  {
    ...
    title: "Google",
    meta: "2026",
    subtitle: "Coursera | Google Data Analytics Professional Certificate",
  },
  {
    ...
    meta: "2024",
    subtitle: "Coursera | Finance & Quantitative Modeling for Analysts Specialization",
  },
  {
  ...
  },
  {
    ...
    subtitle: "Washington, DC | Management & Program Analyst, Digital Delivery Division",
    items: [
      "Onboarded across Federal Student Aid products, workflows, and reporting processes in the Digital Delivery Division; participated in cross-functional meetings and provided status and operational observations to management.",
      "Improved an Excel task tracker by automating deadline and status logic with date-based conditional formatting; secured supervisor approval and led a team walkthrough.",
    ],
  },
  {
    ...
    subtitle: "Los Angeles, CA | Director's Assistant",
    supporting: "Monster(s): The Lyle and Erik Menendez Story - Episodes 201 & 202",
    items: [
      "Served as liaison between director Carl Franklin and production departments on a multimillion-dollar series, coordinating time-sensitive communication and follow-through across teams.",
      "Coordinated housing, travel, technology, equipment, and other operational needs against changing production schedules and priorities.",
      "Managed recurring purchases, expenditure reporting, maintained accurate records, and reprioritized work as schedules and stakeholder needs changed.",
    ],
  },
  {
    ...
    meta: "2021 - 23",
    subtitle: "Los Angeles, CA | Freelance Set Production Assistant",
    items: [
      "Coordinated real-time information flow between production leadership and on-set teams, relaying schedule changes, shot transitions, and operational instructions.",
      "Supported time-sensitive logistics and production-area control across changing team procedures and project environments; selected credits include Oppenheimer, Poolman, Monster: The Jeffrey Dahmer Story, and other productions.",
    ],
  },
  {
  ...
  },
  {
    ...
    meta: "2026",
    subtitle: "Coursera | Capstone: Bellabeat Wellness-Behavior Analysis",
    supporting: "kodyepugh.com/bellabeat-wellness-analysis",
    items: [
      "Built a reproducible workflow for 29 Fitbit source tables and more than 15 million rows, using Excel, BigQuery/SQL, and Python to inspect, transform, validate, and document the data.",
      "Validated source quality and analytical boundaries across daily, hourly, minute, and second-level records, investigating duplicates, uneven feature coverage, and unresolved user identity before defining defensible analytical units.",
      "Analyzed 1,935 activity session-days and translated validated behavior patterns into testable Bellabeat product hypotheses.",
    ],
  },
  {
    id: "independent-consultant",
    type: "entry",
    title: "Various Small Businesses",
    meta: "2025 - 26",
    subtitle: "Remote | Website Consultant & Designer",
    items: [
      "Delivered three website reconstructions across athletics, workforce development, and community events, translating stakeholder needs and fragmented content into requirements, information architectures, CMS structures, user pathways, responsive interfaces, and publishing workflows.",
      "Diagnosed usability and platform gaps, configured structured CMS relationships and dynamic content workflows, and supported launch and post-launch iteration; one event site supported a sold-out, fundraising-goal cycle and generated 28 local-artist inquiries.",
    ],
  },
  {
    id: "academic-film-production",
    type: "entry",
    title: "Stanford University & Loyola Marymount University",
    meta: "2018 - 23",
    subtitle: "California | Academic Film Production Project Lead",
    items: [
      "Led multiple short-film projects from development through final delivery, coordinating teams of up to 10 across writing, casting, production, and post-production.",
      "Built and presented budgets, schedules, approvals, and resource plans; aligned people, locations, equipment, safety, and insurance needs as constraints changed.",
    ],
  },
  {
    id: "student-athlete",
    ...
    title: "Stanford University & Loyola Marymount University",
    meta: "2016 - 21",
    subtitle: "California | NCAA Division I Men's Basketball Scholar-Athlete",
    items: [
      "Earned three Pac-12 All-Academic selections and two NABC Honors Court selections.",
    ],
  },
  {
    id: "skills",
  ...
  },
  {
    ...
    type: "paragraph",
    text: "**Programming Languages:** Java, JavaScript, C++, Python, R, SQL",
  },
  {
    id: "skills-platforms-tools",
    type: "paragraph",
    text: "**Platforms & Tools:** Microsoft Office (Word, Excel, PowerPoint), Google Workspace (Docs, Sheets, Slides), BigQuery, Tableau, Slack, Asana, Trello, Jira",
  },
  {
